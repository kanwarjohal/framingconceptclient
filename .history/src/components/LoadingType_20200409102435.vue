...
<script>
  export default {
    ...
    //         fetch('https://strukanwar.herokuapp.com/framingrequest', selected_loading, input_span)
    //             .then(response => {
    ...
    // }
    mounted: function () {
        axios.get('https://strukanwar.herokuapp.com/framingrequest', selected_loading, input_span)
